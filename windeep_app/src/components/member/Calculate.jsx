...
import { TextField, FormControl, Button , Container,Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper } from "@mui/material";
...
export default function Calculate(props) {
    ...
    const totalInterest = calculation.emiDetails.reduce((total, item) => total + item.interest, 0);
      useEffect(() => {
  ...
  return (
    <React.Fragment>
      ...
      <Table style={{ border: '2px solid black' }}>
        ...
        <TableBody>
          <TableRow>
            <TableCell style={{ border: '1px solid black' }}>Monthly EMI  </TableCell>
            <TableCell style={{ border: '1px solid black' }}>{calculation.emi}</TableCell>

          </TableRow>
          <TableRow>
            <TableCell style={{ border: '1px solid black' }}>Total Interest  </TableCell>
            <TableCell style={{ border: '1px solid black' }}>{totalInterest}</TableCell>

          </TableRow>

          <TableRow>
            <TableCell style={{ border: '1px solid black' }}>Processing Fee  </TableCell>
            <TableCell style={{ border: '1px solid black' }}>{calculation.processingFee}</TableCell>

          </TableRow>

          <TableRow>
            <TableCell style={{ border: '1px solid black' }}>Total Payment  </TableCell>
            <TableCell style={{ border: '1px solid black' }}>{calculation.totalRepayment - calculation.processingFee}</TableCell>
