  ...
  console.log("mainData========================>",id,loan_id)
    ...
    },
    {
      ...
      const handleSubmit = async () => {
        ...
        await fetch('http://localhost:5000/member/loan/addSingleLoan', {
          method: 'POST',
          headers: {
        ...
        await fetch('http://localhost:5000/member/loan/singleLoanDetails', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
      ...
      useEffect(() => {
        ...
        fetch('http://localhost:5000/member/loan/singleLoan', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
          ...
          fetch('http://localhost:5000/member/loan/singleLoanDetails', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
      ...
      const handleDelete = async(row)=>{
        ...
        await fetch('http://localhost:5000/member/loan/deleteTransactionDetails', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
      ...
      const handleEditshare = async()=>{
        ...
        formData.loan_id = loan_id
        await fetch('http://localhost:5000/member/loan/editSingleLoan', {
          method: 'POST', 
          headers: {
            'Content-Type': 'application/json',
          },
